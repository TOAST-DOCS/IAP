<!-- pre-align:aligned sig=e5ef3235fb62 -->

<a id="mobile-service-iap-apple-console-guide"></a>
## Mobile Service > IAP > Apple 콘솔 가이드 { #mobile-service-iap-apple-console-guide }
...
## NHN Cloud SDK iOS 버전별 연동 방식 { #nhn-cloud-sdk-integration-for-ios-versions }
| 버전        | 연동 방식                                                 |
|-----------|----------------------------------------------------------|
...
## (신)영수증 검증+Notification V2 { #new-receipt-verification-notification-v2 }
<a id="generate-keys-for-in-app-purchases"></a>
### 앱 내 구입 키 생성 { #generate-keys-for-in-app-purchases }
> **참고** 
...
<a id="enter-the-in-app-purchase-key-in-the-iap-app-information"></a>
### IAP 앱 정보에 앱 내 구입 키 입력 { #enter-the-in-app-purchase-key-in-the-iap-app-information }
...
### Notification V2 URL 등록 { #register-notification-v2-url }
...
## (구)영수증 검증+Notification V1 (Deprecated 예정) { #old-receipt-verification-notification-v1-soon-to-be-deprecated }
...
### 공유 암호 생성 { #generate-a-shared-secret }
> **참고**
...
<a id="enter-the-shared-secret-in-the-iap-app-information"></a>
### IAP 앱 정보에 Shared Secret 입력 { #enter-the-shared-secret-in-the-iap-app-information }
1. [콘솔](https://console.nhncloud.com)에서 조직 및 프로젝트를 선택하고 **Mobile Service** > **IAP** > **App** > **추가** 또는 App을 선택하고 **편집**을 클릭
2. Store APP ID: **App Bundle ID** 입력
...
### Notification V1 URL 등록 { #register-a-notification-v1-url }
1. **App Store Connect** > **나의 앱** > **앱 선택** > **일반 정보** > **앱 정보** > **App Store 서버 알림**
2. **프로덕션 서버 URL** 또는 **Sandbox 서버 URL** 편집 클릭
3. 알림 버전: **버전 1 알림** 선택
...
## (구)영수증 검증+Notification V1 → (신)영수증 검증+Notification V2 변경 시 주의 사항 { #precautions-for-changing-from-old-receipt-verification-notification-v1-new-receipt-verification-notification-v2 }
