...
## Mobile Service > IAP > STEAM 콘솔 가이드 { #mobile-service-iap-steam-console-guide }
...
### Steam 기본 통화 { #steam-default-currency }
...
## 판매 아이템 설정 { #set-up-items-for-sale }
...
### 아이템 기본 정보 입력 { #enter-item-basic-information }
...
### 국가별 판매 아이템 정보 입력 { #enter-country-specific-sales-item-information }
