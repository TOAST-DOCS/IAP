...
## Mobile Service > IAP > Galaxy Store 콘솔 가이드 { #mobile-service-iap-galaxy-store-console-guide }
...
## IAP Public Key 생성하기 { #generate-iap-public-key }
> **참고**
...
## IAP 콘솔에서 정보 입력하기 { #enter-information-in-the-iap-console }
[NHN Cloud 콘솔](https://console.nhncloud.com)에서 조직 및 프로젝트를 선택하고 **Mobile Service** > **IAP** > **App** > **추가** 또는 App을 선택하고 **편집**을 클릭합니다.
...
## 실시간 서버 알림 (ISN) 등록 { #register-real-time-server-notifications-isn }
