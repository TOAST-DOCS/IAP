...
## Mobile Service > IAP > EPIC 콘솔 가이드 { #mobile-service-iap-epic-console-guide }
...
## 에픽 프로젝트 연결 { #connect-epic-project }
...
### 아이템 ID 확인 및 IAP 등록 { #check-item-id-and-register-iap }
