...
## Mobile Service > IAP > Apple Console Guide { #mobile-service-iap-apple-console-guide }
...
### Enter the in-app purchase key in the IAP app information { #enter-the-in-app-purchase-key-in-the-iap-app-information }
...
### Enter the Shared Secret in the IAP app information { #enter-the-shared-secret-in-the-iap-app-information }
1. [In the console,](https://console.nhncloud.com)select the organization and project, **Mobile Service** > **IAP** > **App** > **Add** or select an app, and click **Edit**
2. Store APP ID: Enter your **App Bundle ID** 
