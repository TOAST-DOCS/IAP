<!-- pre-align:aligned sig=e182d49952ac -->

<a id="mobile-service-iap-release-notes"></a>
## Mobile Service > IAP > Release Notes { #mobile-service-iap-release-notes }


<a id="mobile-service-iap-release-notes-1"></a>
### 27 { #mobile-service-iap-release-notes-1 }

<!-- TODO: translate body -->

<a id="mobile-service-iap-release-notes-1-consumable-subscription-product-feature-added"></a>
#### Consumable Subscription Product Feature Added

<!-- TODO: translate body -->

<a id="mobile-service-iap-release-notes-1-one-store-sandbox-payment-fixes"></a>
#### ONE Store Sandbox Payment Fixes

<!-- TODO: translate body -->

<a id="mobile-service-iap-release-notes-2"></a>
### 2018.12.04 { #mobile-service-iap-release-notes-2 }
<a id="mobile-service-iap-release-notes-2-new-sdk-release"></a>
#### New SDK Release
...
<a id="mobile-service-iap-release-notes-3"></a>
### 2018.10.23 { #mobile-service-iap-release-notes-3 }
<a id="mobile-service-iap-release-notes-3-1"></a>
#### 버그수정
...
<a id="mobile-service-iap-release-notes-4"></a>
### 2018.09.04 { #mobile-service-iap-release-notes-4 }

<a id="mobile-service-iap-release-notes-4-1"></a>
#### 기능추가
...
<a id="mobile-service-iap-release-notes-5"></a>
### 2018.08.28 { #mobile-service-iap-release-notes-5 }
<a id="mobile-service-iap-release-notes-5-1"></a>
#### 기능개선/변경
...
<a id="mobile-service-iap-release-notes-6"></a>
### 2018.07.31 { #mobile-service-iap-release-notes-6 }
<a id="mobile-service-iap-release-notes-6-1"></a>
#### 기능추가/개선/변경
...
<a id="mobile-service-iap-release-notes-6-2"></a>
#### 기능추가
* [SDK][[AOS-1.5.0](/Download/#mobile-service-iap)]
    * One Store V17 추가  
      
<a id="mobile-service-iap-release-notes-6-3"></a>
#### 기능개선/변경
* [SDK][[iOS-1.5.6](/Download/#mobile-service-iap)]
    * Release Build 시 발생하던 ModuleCache Warning 제거
    * 내부 네트워크 통신 모듈 개선

<a id="mobile-service-iap-release-notes-7"></a>
### 2018.07.24 { #mobile-service-iap-release-notes-7 }
<a id="mobile-service-iap-release-notes-7-1"></a>
#### 기능개선/변경
...
<a id="mobile-service-iap-release-notes-8"></a>
### 2018.06.26 { #mobile-service-iap-release-notes-8 }
<a id="mobile-service-iap-release-notes-8-1"></a>
#### 기능 개선
* [Console] 결제내역 조회 - 결제상태 조건 추가

<a id="mobile-service-iap-release-notes-9"></a>
### 2018.06.05 { #mobile-service-iap-release-notes-9 }

<a id="mobile-service-iap-release-notes-9-1"></a>
#### 기능추가
...
<a id="mobile-service-iap-release-notes-9-2"></a>
#### 기능개선/변경
* [SDK][[AOS-1.4.1](/Download/#mobile-service-iap)]
    * Eclipse 지원 중단
    * aar 형식으로 SDK 배포
...
<a id="mobile-service-iap-release-notes-10"></a>
### 2018.05.29 { #mobile-service-iap-release-notes-10 }
<a id="mobile-service-iap-release-notes-10-1"></a>
#### 기능 개선
* [Console] 결제내역 조회 - 결제상태코드 변경 및 툴팁 노출 개선

<a id="mobile-service-iap-release-notes-11"></a>
### 2018.05.03 { #mobile-service-iap-release-notes-11 }
<a id="mobile-service-iap-release-notes-11-1"></a>
#### 버그 수정
...
<a id="mobile-service-iap-release-notes-12"></a>
### 2018.05.02 { #mobile-service-iap-release-notes-12 }
<a id="mobile-service-iap-release-notes-12-1"></a>
#### 기능 개선
...
<a id="mobile-service-iap-release-notes-12-2"></a>
#### 버그 수정
* [SDK][[iOS-1.5.3](/Download/#mobile-service-iap)]
    * Refresh Receipt 버그 수정

<a id="mobile-service-iap-release-notes-13"></a>
### 2018.03.22 { #mobile-service-iap-release-notes-13 }
<a id="mobile-service-iap-release-notes-13-1"></a>
#### 기능개선
* [Console] Transaction 탭 검색기간 한 달로 변경

<a id="mobile-service-iap-release-notes-14"></a>
### 2018.02.22 { #mobile-service-iap-release-notes-14 }
<a id="mobile-service-iap-release-notes-14-1"></a>
#### 기능 개선
* [Console] Transaction 탭 Excel 다운로드 기능 추가
* [Console] Transaction 탭 조회/Excel 다운로드 검색기간 7일로 수정
* [Console] 스토어결제번호 검색기능추가

<a id="mobile-service-iap-release-notes-14-2"></a>
#### 버그 수정
...
<a id="mobile-service-iap-release-notes-15"></a>
### 2018.01.31 { #mobile-service-iap-release-notes-15 }

<a id="mobile-service-iap-release-notes-15-1"></a>
#### 기능 개선
...
<a id="mobile-service-iap-release-notes-16"></a>
### 2018.01.24 { #mobile-service-iap-release-notes-16 }

<a id="mobile-service-iap-release-notes-16-1"></a>
#### 버그 수정
* [SDK][[AOS-1.3.7](/Download/#mobile-service-iap)] 릴리스
    * 구글 결제 시  20개 이상의 아이템을 한번에 검색하는 경우, 검색에 실패하는 버그 수정

<a id="mobile-service-iap-release-notes-17"></a>
### 2017.12.21 { #mobile-service-iap-release-notes-17 }

<a id="mobile-service-iap-release-notes-17-1"></a>
#### 버그 수정
...
<a id="mobile-service-iap-release-notes-18"></a>
### 2017.09.21 { #mobile-service-iap-release-notes-18 }

<a id="mobile-service-iap-release-notes-18-1"></a>
#### 기능 개선/변경
...
<a id="mobile-service-iap-release-notes-19"></a>
### 2017.08.24 { #mobile-service-iap-release-notes-19 }

<a id="mobile-service-iap-release-notes-19-1"></a>
#### 버그 수정
...
<a id="mobile-service-iap-release-notes-19-2"></a>
#### 기능 개선/변경
...
<a id="mobile-service-iap-release-notes-20"></a>
### 2017.07.20 { #mobile-service-iap-release-notes-20 }

<a id="mobile-service-iap-release-notes-20-1"></a>
#### 버그 수정
...
<a id="mobile-service-iap-release-notes-20-2"></a>
#### 기능 개선/변경

* [SDK][[iOS-1.4.4](/Download/#mobile-service-iap)][[Unity-1.5.3](/Download/#mobile-service-iap)] 릴리스
    * 결제 종료시점 변경 (finishTransaction의 실행시점변경. 기존 : 영수증 검증이후, 변경 : 영수증 검증이전)

<a id="mobile-service-iap-release-notes-21"></a>
### 2017.06.29 { #mobile-service-iap-release-notes-21 }

<a id="mobile-service-iap-release-notes-21-1"></a>
#### 버그 수정
...
<a id="mobile-service-iap-release-notes-21-2"></a>
#### 기능 개선/변경

* [SDK][[Android-1.3.3.1](/Download/#mobile-service-iap)][[Unity-1.5.2](/Download/#mobile-service-iap)] 릴리스
    * mobill-core 모듈에 물리적으로 포함되던 okhttp.jar 및 gson.jar 파일을 제거하고, gradle 의존성 설정으로 변경

<a id="mobile-service-iap-release-notes-22"></a>
### 2017.04.20 { #mobile-service-iap-release-notes-22 }

<a id="mobile-service-iap-release-notes-22-1"></a>
#### 버그 수정
* TEST 마켓 사용시 영수증 검증 처리가 안되는 문제 수정

<a id="mobile-service-iap-release-notes-23"></a>
### 2017.04.04 { #mobile-service-iap-release-notes-23 }

<a id="mobile-service-iap-release-notes-23-1"></a>
#### 기능 개선/변경

* [API] 아이템 조회, 미소비내역 조회 API 추가


<a id="mobile-service-iap-release-notes-24"></a>
### 2017.02.23 { #mobile-service-iap-release-notes-24 }

<a id="mobile-service-iap-release-notes-24-1"></a>
#### 기능 개선/변경

* [Console] 명칭 변경(Market > Store)
* [Console] 결제내역 조회시 결제번호(ID 컬럼)  정렬 기능 추가

<a id="mobile-service-iap-release-notes-24-2"></a>
#### 버그 수정
...
<a id="mobile-service-iap-release-notes-25"></a>
### 2017.01.19 { #mobile-service-iap-release-notes-25 }

<a id="mobile-service-iap-release-notes-25-1"></a>
#### 기능 개선/변경
...
<a id="mobile-service-iap-release-notes-26"></a>
### 2016.12.22 { #mobile-service-iap-release-notes-26 }

<a id="mobile-service-iap-release-notes-26-1"></a>
#### 기능 개선/변경
...
<a id="mobile-service-iap-release-notes-27"></a>
### 2016.11.29 { #mobile-service-iap-release-notes-27 }

<a id="mobile-service-iap-release-notes-27-1"></a>
#### 기능 개선/변경
...
<a id="mobile-service-iap-release-notes-28"></a>
### 2016.11.24 { #mobile-service-iap-release-notes-28 }

<a id="mobile-service-iap-release-notes-28-1"></a>
#### 버그 수정
...
<a id="mobile-service-iap-release-notes-29"></a>
### 2016.11.02 { #mobile-service-iap-release-notes-29 }

<a id="mobile-service-iap-release-notes-29-1"></a>
#### 기능 추가
...
<a id="mobile-service-iap-release-notes-29-2"></a>
#### 기능 삭제

* [SDK][Android] 네이버 라이브러리 삭제

<a id="mobile-service-iap-release-notes-30"></a>
### 2016.10.12 { #mobile-service-iap-release-notes-30 }

<a id="mobile-service-iap-release-notes-30-1"></a>
#### 버그 수정
...
<a id="mobile-service-iap-release-notes-31"></a>
### 2016.09.29 { #mobile-service-iap-release-notes-31 }

<a id="mobile-service-iap-release-notes-31-1"></a>
#### 기능 개선/변경
...
<a id="mobile-service-iap-release-notes-32"></a>
### 2016.09.22 { #mobile-service-iap-release-notes-32 }

<a id="mobile-service-iap-release-notes-32-1"></a>
#### 버그 수정

* [SDK][[Unity-1.4.3.1](/Download/#mobile-service-iap)] 릴리스
    * 구 서버 API 조회 수정 및 유니티 커스텀 패키지내의 안드로이드 모듈 수정

<a id="mobile-service-iap-release-notes-33"></a>
### 2016.08.24 { #mobile-service-iap-release-notes-33 }

<a id="mobile-service-iap-release-notes-33-1"></a>
#### 기능 추가
...
<a id="mobile-service-iap-release-notes-34"></a>
### 2016.08.04 { #mobile-service-iap-release-notes-34 }

<a id="mobile-service-iap-release-notes-34-1"></a>
#### 기능 개선/변경
